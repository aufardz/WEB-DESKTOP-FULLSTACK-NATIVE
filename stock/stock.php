                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="jenis">Kode Barang</label>
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								...
								<div class="form-group">
									...
									<input name="jenis" type="text" class="form-control" placeholder="Kode Barang">
								</div>
								<div class="form-group">
									<label>Jenis</label>
									<input name="merk" type="text" class="form-control" placeholder="Jenis">
								</div>
								<div class="form-group">
									<label>Deskripsi</label>
									<input name="ukuran" type="text" class="form-control" placeholder="Deskripsi">
								</div>
								<div class="form-group">
									<label>Stock</label>
